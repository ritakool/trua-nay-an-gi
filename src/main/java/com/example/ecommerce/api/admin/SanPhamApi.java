...
import com.example.ecommerce.validator.SanPhamDtoValidator;
...
public class SanPhamApi {
    ...
    public void saveImageForProduct(SanPham sp, SanPhamDto dto, HttpServletRequest request) {
        ...
        String uploadDirectory = "F:\\Code Gym\\module4\\casestudy04\\Case_Study_MD4_Team4\\src\\main\\resources\\static\\images\\";
        Path path = Paths.get(uploadDirectory + sp.getId() + ".png");
//        String rootDirectory = request.getSession().getServletContext().getRealPath("/");
//        Path path = Paths.get(rootDirectory + "/images/" + sp.getId() + ".png");
